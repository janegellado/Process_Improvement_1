            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-user"></i> Sales Agent Management</a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-tachometer"></i> Client Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-line-chart"></i> Sales Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
